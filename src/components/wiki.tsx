...
const articleImports = import.meta.glob("../wiki-articles/*.txt", { query: "?raw", import: "default" });
  ...
  >
    <Sidebar className="w-64 h-screen rounded-r-2xl z-40 shadow-xl bg-gray-800">
      <div className="flex flex-col items-center p-4">
        ...
        <h2 className="text-lg font-semibold text-white mb-4 text-center">Paintbloat official wiki</h2>
      </div>
      ...
      <div className="flex flex-col items-center p-4">
        ...
        <h3 className="text-lg text-gray-700 mb-4 text-center">We thank our community for their support! ; )</h3>
      </div>
    </Sidebar>
  </div>
);
    ...
    <section className="flex gap-6 min-h-screen w-full p-6 bg-gray-800 rounded-lg shadow-md">
      ...
      <div
        className={`
          ...
          ${animateContent ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"}
        `}
      >
        {selected ? (
          <>
