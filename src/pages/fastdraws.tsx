    ...
    <section className=" w-full h-full bg-gray-300 dark:bg-gray-900 min-h-screen flex items-center justify-center px-6 py-8 flex-col space-y-4">
      ...
      <div className="flex relative">
        ...
        <section className="absolute right-[0px] translate-x-3/2 translate-y-2/4 h-[200px] justify-around flex flex-col bg-gray-800 p-2 rounded-xl">
          <Button className="group focus:outline-none focus:ring-0 !bg-white  dark:!bg-black !border-2 hover:!border-white  aspect-square !p-0 h-12">
            <MessageCircle
              color={isDark ? "white" : "black"}
              className={photoIcon}
            />
          </Button>
          <Button className="group focus:outline-none !bg-white  dark:!bg-black !border-2 focus:ring-0 hover:!border-white aspect-square !p-0 h-12">
      ...
      <div className="flex mt-3 gap-2 bg-gray-700 p-2 rounded-xl">
        <Button className="group !bg-white  dark:!bg-black !border-2 focus:outline-none focus:ring-0 hover:!border-green-500 !border-gray-700">
          <Laugh color={isDark ? "white" : "black"} className={photoIcon} />
        </Button>
        <Button className="group !bg-white  dark:!bg-black !border-2 bg-gradient-t focus:outline-none focus:ring-0 hover:!border-yellow-400">
          <Smile color={isDark ? "white" : "black"} className={photoIcon} />
        </Button>
        <Button className="group !bg-white  dark:!bg-black !border-2 focus:outline-none focus:ring-0 hover:!border-gray-400">
          <Meh color={isDark ? "white" : "black"} className={photoIcon} />
        </Button>
        <Button className="group !bg-white  dark:!bg-black !border-2 focus:outline-none focus:ring-0 hover:!border-red-500">
          <Frown color={isDark ? "white" : "black"} className={photoIcon} />
        </Button>
        <Button className="group !bg-white  dark:!bg-black !border-2 focus:outline-none focus:ring-0 hover:!border-red-800">
